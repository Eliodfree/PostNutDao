const MissionSection = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-cyan-5 to-white bg-green-40">
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-12 ">
        ...
        `,
          ...
          <div className="flex flex-col items-center justify-center text-center sm:absolute sm:inset-0 sm:justify-end">
            ...
            <p className="text-gray-700 text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
              ...
              educate the masses on men's health in an easy and accessible way
              for everyone.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-evenly max-w-4xl mx-auto text-center relative  ">
          ...
          {/* <div
            className="absolute top-0 right-0   w-[200px] h-[200px] items-center justify-center text-white block lg:hidden"
            style={{
              background:
                "radial-gradient(circle, rgba(255, 177, 177, 0.5) 0%, transparent 72%)",
            }}
          >
      ...
      <div
        className="absolute bottom-60 right-10 rounded-full w-[300px] h-[300px] flex items-center justify-center text-white hidden lg:block"
        style={{
          background:
            "radial-gradient(circle, rgba(255, 177, 177, 0.1) 0%, transparent 72%)",
        }}
      >
      ...
      <div
        className="absolute top-80 left-0 right-0 rounded-full w-[400px] h-[400px] flex items-center justify-center text-white hidden lg:block"
        style={{
          background:
            "radial-gradient(circle, rgba(255, 177, 177, 0.3) 0%, transparent 72%)",
        }}
      >
        <p className="text-sm">{/* Your content here */}</p>
      </div>
      ...
      <div
        className="absolute bottom-20 left-10 right-0 rounded-full w-[500px] h-[500px] flex items-center justify-center text-white hidden lg:block"
        style={{
          background: "radial-gradient(circle, #A5F3FC 0%, transparent 72%)",
        }}
      ></div>
    </div>
  );
